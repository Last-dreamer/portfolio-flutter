                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              await launchUrl(
                                  Uri.parse("https://github.com/Last-dreamer"));
                            },
                            onHover: (bol) {
                              togglePointerSize(bol);
                              if (bol) {
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async{
                                 ...
                                 await launchUrl(
                                  Uri.parse("https://www.instagram.com/lost2dreamer/"));
                              },
                              onHover: (bol) {
                                 togglePointerSize(bol);
                                if (bol) {
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                 await launchUrl(
                                  Uri.parse("https://www.linkedin.com/in/lost2dreamer"));
                              },
                              onHover: (bol) {
                                 togglePointerSize(bol);
                                if (bol) {
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: ()async {
  await launchUrl(Uri.parse("https://twitter.com/lost2dreamer?t=5nNpt18xFR56y0rX3CEHwg&s=09"));
